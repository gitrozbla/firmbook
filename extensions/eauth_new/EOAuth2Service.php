...
abstract class EOAuth2Service extends EAuthServiceBase implements IAuthService {
	...
	public function authenticate() {
		echo "<br>extensions/eauth/services/EOAuth2Service->authenticate()<br>";
		...
		if (isset($_GET['code'])) {
			$code = $_GET['code'];
			echo '<br>before getAccessToken<br>';
...
// 		exit;
	...
	protected function getAccessToken($code) {
		echo '<br>extensions/eauth/EOAuth2Service->getAccessToken()<br>';
	...
	{
		echo "<br>extensions/eauth/EOAuth2Service->getSignedRequestFields()<br>";
	...
	public function makeSignedRequest($url, $options = array(), $parseJson = true) {
		echo "<br>extensions/eauth/EOAuth2Service->makeSignedRequest()<br>";
