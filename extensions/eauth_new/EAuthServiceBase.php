...
abstract class EAuthServiceBase extends CComponent implements IAuthService {
	...
	protected function makeRequest($url, $options = array(), $parseJson = true) {
		echo "<br>extensions/eauth/EAuthServiceBase->makeRequest()<br>";
		echo $url."<br><br>";
...
// 		$new_url="";
// 		for($i=0;$i<count($urls_parts)-1;$i++)
// 			$new_url.=($i!=0? "&" : "").$urls_parts[$i];
// 		echo "<br><br>".$new_url."<br><br>";
// 		var_dump($options);
// 		exit;
...
// 		exit;
	...
	protected function _fetchAttributes() {
		echo "<br>extensions/eauth/EAuthServiceBase->_fetchAttributes()<br>";
	...
	public function getAttributes() {
		echo "<br>extensions/eauth/EAuthServiceBase->getAttributes()<br>";
		$this->_fetchAttributes();
		$attributes = array();
