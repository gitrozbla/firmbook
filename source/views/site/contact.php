...
//                'id' => 'contact-form',
            ...
            <div class="control-group">
                <label class="control-label required" for="Contact_subject"></label>
                <div class="controls">
...
//                            'id' => 'submitBtnWithRecaptcha'
    ...
    <div class="span3">
        <?php $this->beginWidget(
            ...
            <p>
                <?php echo Yii::t('contact', 'This platform is operated by'); ?>: <br />
                ...
                <?php echo $brand['street']; ?> <?php echo $brand['home']; ?><br />
