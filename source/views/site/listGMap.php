...
<script>			
			...
			<?php if($type == 'company') : ?>
				<?php foreach($items as $item) : ?>
					<?php if($item->company->map_lat && $item->company->map_lng) : ?>				                        
					markerTab = [];
			...
			<?php elseif($type == 'product') : ?>	
				<?php foreach($items as $item) : ?>
					<?php if(isset($item->product->company) && $item->product->company->map_lat && $item->product->company->map_lng) : ?>
						markerTab = [];
			...
			<?php elseif($type == 'service') : ?>	
				<?php foreach($items as $item) : ?>
					<?php if(isset($item->service->company) && $item->service->company->map_lat && $item->service->company->map_lng) : ?>
						markerTab = [];
...
<?php Yii::app()->clientScript->registerScript('toggle-all-markers', "			
