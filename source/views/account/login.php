...
<h2><?php echo Yii::t('account', 'Do you already have an account on one of these sites? Click the logo to log in with it here:') ?></h2>
                        
<?php $this->widget('ext.eauth.EAuthWidget', array('action' => 'account/remote_login')); ?>
<?php /*
            <p><?php echo Yii::t('common', 'or'); ?></p>
            <!--
            ...
            <br /><br /><p><?php echo Yii::t('common', 'or'); ?></p>            
            <?php require '_remoteLoginGoogle.php'; ?>
*/ ?>            
