...
<?php
    ...
    $packageLast = User::model()->getLastPackage(Yii::app()->user->id, Yii::app()->params['websiteMode'] == 'creators');
    ...
    $tdvAttributes[] = array(
    		'value'=> Package::badge($packageCurrent['name'], $packageCurrent['css_name'], true)    		
	...
	{
		$tdvAttributes[] = array(
			'value'=> $user['package_expire'] ? Yii::app()->dateFormatter->format("yyyy-MM-dd", $user['package_expire']) : Yii::t('packages', 'No limit'),
