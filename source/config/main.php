...
return array(
    ...
    'import' => array(
       ...
       // 'application.modules.comments.CommentsModule',
        'application.modules.likedislike.widgets.*',
        'application.modules.likedislike.LikedislikeModule',
    	/* social login */
    	'ext.eoauth.*',
    	'ext.eoauth.lib.*',
    	'ext.lightopenid.*',
    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                '_companies/<companies_context:[\w\-]+>/<name:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),
                '_products/<products_context:[\w\-]+>/<name:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),
                '_services/<services_context:[\w\-]+>/<name:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),

            	'_companies/<companies_context:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),
            	'_products/<products_context:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),
            	'_services/<services_context:[\w\-]+>/<search_context:(search)>' => array('_categories/show'),
            		
            	'_companies/<companies_context:[\w\-]+>/<name:[\w\-]+>' => array('_categories/show'),            	
            	'_products/<products_context:[\w\-]+>/<name:[\w\-]+>' => array('_categories/show'),
            	'_services/<services_context:[\w\-]+>/<name:[\w\-]+>' => array('_categories/show'),
            		
//             	'_companies/<companies_context:[\w\-]+>' => array('_site/index', 'defaultParams'=>array('no_params_translate'=>true)),
            	'_companies/<companies_context:[\w\-]+>' => array('_site/index'), // po prostu nie jest potrzebne w kolejnych też nie, ale sprawdzić najpierw             	
            	'_products/<products_context:[\w\-]+>' => array('_site/index', 'defaultParams'=>array('no_params_translate'=>true)),
            	'_services/<services_context:[\w\-]+>' => array('_site/index', 'defaultParams'=>array('no_params_translate'=>true)),
        ...
        'cache' => array(
            //'class'=>'CDummyCache',
//             'class' => 'CDbCache',
        	'class' => 'application.components.other.AppCDbCache',
            'connectionID' => 'db',
...
//             'class' => 'CDbCache',
        	'class' => 'application.components.other.AppCDbCache',
            'connectionID' => 'db',
            'cacheTableName' => 'tbl_yii_spool_cache',
            'autoCreateCacheTable' => true,
        ),
        'stats' => array(
    ...
    'params' => array(
      	...
      	'google' => array(
      		'map' => array(
      				...
      				'markers' => array('A','B','C','D','E',
      								...
      								'P','Q','R','S','T',
      								'U','W','X','Y','Z'),
      				'keyMapsJavaScriptApi' => 'AIzaSyAjHkn6vzEOTCy7BbWDTHM-waWE-HnIPRo' 
      		),
      		//www.firmbook.eu
        ...
        'recaptcha' => array(
            ...
            'sitekey' => '6LdF8KsUAAAAAAGRJ-pxImM0jhgYkZwQi2vDVXlz',
            'secret' => '6LdF8KsUAAAAAEzEitXq5mMuBXyUOndc-gR9VTK5'
        )
    ),
