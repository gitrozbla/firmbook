...
//$_SERVER['SERVER_NAME'] = 'creators.localhost';
$_SERVER['SERVER_NAME'] = '/www.fbcreators.eu';
$_SERVER['argv'] = array(__FILE__, 'runcron');
...
file_put_contents(dirname(__FILE__) . '/last_cron_run_creators.txt', date('r'));
